...
print(gline_final + theme(axis.text.x = element_text(angle=60, hjust=1)))
```
Sulfaattit eroavat ensimmaisina mittausajankohtina, kunnes 2016 syksylla erot haviavat.
