...
Laske erot vuosien valilla s1-4 vs mineraali
...
Kokessa tarkasteltiin lannoitteiden ja kasvikäsittelyiden vaikutusta nitraatti- ja sulfaattipitoisuuksiin peltomaassa. Huuhtoumalle altis typpi väheni rukiilla mahdollisesti lisätyn hiilen vaikutuksesta ensimmäisenä vuonna  **-62 % p>0.05**, toisena vuonna **y** ja kolmantena vuonna **+7% p>0.05** verrattuna pelkkään kemialliseen lannoitukseen. Mittaukset tehtiin syksyllä ja kerran kevaalla. Lannoitteet lisäsivät sulfaattipitoisuuksia ensimmäisenä vuonna **64 %**, mutta toisen vuoden jälkeen sulfaattipitoisuus oli palautunut alkuperäiselle tasolle.
...
Käsittelyt S1-S3 ja mineraaali ovat samoja, S4 ja kontrolli eroavat toisistaan ja muista käsittelyistä. S4 eron selittää kaksi poikkeavaa havaintoa, jotka voi olla sattumaa. Kasvikäsittelyillä ei ollut merkitsevää eroa, ja siksi käsittelyt on tässä yhdistetty. Käytännössä lannoitteiden rikkiä lisäävä vaikutus kestää kaksi satokautta.
